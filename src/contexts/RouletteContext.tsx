...
import { get, post } from '../Backbone.tsx';
import { IRoulettePreview, SearchItemContract } from '../server/Contracts.tsx';
import { DefaultProp } from '../Utils/DefaultProp.tsx';
...
const RouletteProvider: React.FC<DefaultProp> = (p) => {
